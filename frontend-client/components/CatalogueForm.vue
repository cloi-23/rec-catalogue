...
const saveCatalogues = async () => {
  await $fetch("http://192.168.1.38:4001/catalogues", {
    method: "POST",
    body: fields.value,
  });
  emit("refresh");
...
<template>
  <button
    class="h-12 mt-1 text-white dark:bg-blue-700 border-2 bg-gray-400 dark:hover:bg-blue-800 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
    @click="openForm"
  >
    ADD +
  </button>
